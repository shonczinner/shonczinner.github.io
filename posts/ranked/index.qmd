...
description: "Ranked ballots (IRV, Borda, Condorcet, and Condorcet-completion methods) still center-squeeze the median candidate under strategic voting"
author: "Shon Czinner"
date: "2026-08-28"
...
IRV is also susceptible to other forms of strategic voting, like "compromising" (ranking a less-preferred candidate higher to avoid wasting your vote). Note that in this system, it appears that candidate A is the weakest candidate as they are eliminated first, so compromising is unlikely to help A. It's likely A voters that would compromise to vote for B or C, not B or C voters that would compromise to help A. Compromising would only make A's loss more likely.
